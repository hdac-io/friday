...
import (
	...
	authsim "github.com/hdac-io/friday/x/auth/simulation"
	"github.com/hdac-io/friday/x/bank"
	distr "github.com/hdac-io/friday/x/distribution"
	distrsim "github.com/hdac-io/friday/x/distribution/simulation"
	"github.com/hdac-io/friday/x/gov"
	govsim "github.com/hdac-io/friday/x/gov/simulation"
	"github.com/hdac-io/friday/x/mint"
	"github.com/hdac-io/friday/x/params"
	paramsim "github.com/hdac-io/friday/x/params/simulation"
	"github.com/hdac-io/friday/x/simulation"
	"github.com/hdac-io/friday/x/slashing"
	slashingsim "github.com/hdac-io/friday/x/slashing/simulation"
	"github.com/hdac-io/friday/x/staking"
	stakingsim "github.com/hdac-io/friday/x/staking/simulation"
...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *FridayApp) (
...
func testAndRunTxs(app *FridayApp) []simulation.WeightedOperation {
	cdc := MakeCodec()
...
func invariants(app *FridayApp) []sdk.Invariant {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/cosmos/cosmos-sdk/FridayApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewFridayApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewFridayApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "FridayApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewFridayApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
...
func TestAppSimulationAfterImport(t *testing.T) {
	...
	newApp := NewFridayApp(log.NewNopLogger(), newDB, nil, true, 0, fauxMerkleModeOpt)
	require.Equal(t, "FridayApp", newApp.Name())
