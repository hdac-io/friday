...
func TestValidatorTestEquivalent(t *testing.T) {
	accAddr := "friday1gp2u22697kz6slwa25k2tkhz6st2l0zx3hkfc5wdlpjaauv5czsq2dwu8m"
	acc, _ := sdk.AccAddressFromBech32(accAddr)
	valAddr := sdk.ValAddress(acc)

	require.Equal(t, "fridayvaloper1gp2u22697kz6slwa25k2tkhz6st2l0zx3hkfc5wdlpjaauv5czsqcd3mya", valAddr.String())
