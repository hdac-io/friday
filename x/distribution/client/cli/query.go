...
import (
	...
	"github.com/hdac-io/friday/x/distribution/client/common"
...
Example:
$ %s query distr validator-outstanding-rewards fridayvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission fridayvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes fridayvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards friday1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
$ %s query distr rewards friday1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p fridayvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
