...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "clif",
		Short: "Command line interface for interacting with friday daemon",
	}
	...
	// Add flags and prefix all env exposed with FR
	executor := cli.PrepareMainCmd(rootCmd, "FR", app.DefaultCLIHome)
